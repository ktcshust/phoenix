...
import type { TimeoutStatusTimeSeriesQuery } from "./__generated__/TimeoutStatusTimeSeriesQuery.graphql";
...
export function TimeoutStatusTimeSeries({
  projectId,
  timeRange,
}: ProjectMetricViewProps) {
  const scale = useTimeBinScale({ timeRange });

  const data = useLazyLoadQuery<TimeoutStatusTimeSeriesQuery>(
    graphql`
      query TimeoutStatusTimeSeriesQuery(
        $projectId: ID!
        $timeRange: TimeRange!
