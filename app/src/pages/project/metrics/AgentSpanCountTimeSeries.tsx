...
import type { AgentSpanCountTimeSeriesQuery } from "./__generated__/AgentSpanCountTimeSeriesQuery.graphql";
...
export function AgentSpanCountTimeSeries({
  projectId,
  timeRange,
  ...
  const data = useLazyLoadQuery<AgentSpanCountTimeSeriesQuery>(
    graphql`
      query AgentSpanCountTimeSeriesQuery(
        $projectId: ID!
        $timeRange: TimeRange!
