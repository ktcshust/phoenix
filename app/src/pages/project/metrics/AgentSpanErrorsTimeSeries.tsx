...
import type { AgentSpanErrorsTimeSeriesQuery } from "./__generated__/AgentSpanErrorsTimeSeriesQuery.graphql";
...
export function AgentSpanErrorsTimeSeries({
  projectId,
  timeRange,
  ...
  const data = useLazyLoadQuery<AgentSpanErrorsTimeSeriesQuery>(
    graphql`
      query AgentSpanErrorsTimeSeriesQuery(
        $projectId: ID!
        $timeRange: TimeRange!
